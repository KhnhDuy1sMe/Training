...
def load_data_from_json(filepath: str) -> Dict:
    ...
    data = {
        ...
        # *** SỬA LỖI 1: Chuyển mem_total sang số nguyên ***
    ...
    for pm_index, pm in enumerate(raw_data):
        for vm in pm.get("vms", []):
            ...
            # *** SỬA LỖI 2: Chuyển mem của từng VM sang số nguyên ***
...
def main():
    ...
    DATASET_JSON_PATH = r'E:\VM 2025\vm_offline_scheduling\dataset\30-1.json'
    P_SLA = 0.05
    ALPHA = 10**3
    ...
    print("Bắt đầu giải bài toán với Google OR-Tools (CP-SAT Solver)...")
